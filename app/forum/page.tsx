...
const Forum = () => {
  ...
  return (
    <div className={styles.forumOldal}>
      <div className="navbar bg-green-500 w-5/6 mx-auto shadow-sm rounded-md">
        ...
        <div className="navbar-end">
          <a className="btn p-0 sm:p-3 " onClick={toggleExpand}>
            Új poszt
          </a>
        </div>
      </div>
      ...
      {/*Posts place*/}
      <div className="bg-white sm:w-3/4 w-5/6 mx-auto pt-7 rounded-xl shadow-lg pb-4">
        {/* hidden searchbar */}
        <div className={styles.hiddenSearch}>
          <input
            ...
            name="name"
            placeholder="Keresés..."
            className="input input-bordered w-3/4 max-w-96"
          />
        </div>
        <Poszt
          cim="Poszt címe"
      ...
      {isExpanded && (
        <div className="absolute inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-10">
          <div className="bg-white rounded-lg shadow-md p-4 md:w-1/2 lg:1/3">
          ...
          {isWarningAlertOpen && (
            <div role="alert" className="alert alert-error absolute bottom-0 left-0 right-0 text-center mb-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span>Sikertlene posztolás! Nincsen mindegyik mező kitöltve!</span>
            </div>
          )}
        </div>
      )}
