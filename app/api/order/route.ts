  ...
  try {
    ...
    await sendMail({
      ...
      body: compileRegisterTemplate(
        ...
        mail,
        "Sikeres rendelés",
        "Feldolgoztuk a rendelését, amelyet az El Terrifico étterem weboldalán indított ezzel az email címmel! Köszönjük, hogy minket választott, és reméljük, hogy a legmegfelelőbb ételekkel tudjuk Önt szolgálni. A rendelésének részleteit fiókjának beállítások nevű menüpontjára rákattintva Rendelések cím alatt találhatja.  Az oldalra visszatérhet a 'Vissza az oldalra' gombbal"
      ),
    });
